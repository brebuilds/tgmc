      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-3xl sm:text-4xl font-alata font-bold text-primary">
              Built in{' '}
              <span className="text-gradient-primary">Partnership</span>{' '}
              With
            </h3>
            <p className="text-lg sm:text-xl text-muted-foreground font-lexend">
            ...
            >
              <div className="relative">
                <img 
                  ...
                  className="h-24 sm:h-28 lg:h-32 w-auto opacity-100 group-hover:opacity-90 transition-opacity duration-300"
                />
