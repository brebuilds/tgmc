...
            </Button>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 items-center max-w-md mx-auto mt-8">
            <input
              type="email"
              placeholder="Enter email"
              className="flex-1 h-12 px-4 rounded-md border border-white/30 bg-white/10 text-white text-sm placeholder:text-white/70"
            />
            <Button
              variant="outline"
              size="lg"
